...
/**
 * Public social profiles for Minor Shop.
 *
 ...
 * one source of truth for "how to reach Minor Shop on WhatsApp".
 *
...
export const SOCIAL_LINKS: Record<SocialKey, { href: string }> = {
  instagram: { href: "https://instagram.com/minorshop" },
  facebook: { href: "https://facebook.com/minorshop" },
